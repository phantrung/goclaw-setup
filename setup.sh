...
echo -e "    ${CYAN}cd ${INSTALL_DIR} && docker compose logs -f goclaw${NC}   ${DIM}# View logs${NC}"
echo -e "    ${CYAN}cd ${INSTALL_DIR} && docker compose down${NC}             ${DIM}# Stop server${NC}"
echo -e "    ${CYAN}cd ${INSTALL_DIR} && docker compose up -d${NC}            ${DIM}# Start server${NC}"
echo -e "    ${CYAN}cd ${INSTALL_DIR} && docker compose ps${NC}               ${DIM}# Status${NC}"
echo ""
